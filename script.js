function checkReddish() {
    const imageData = document.getElementById("img_1").src; // Get image data
    ...
    .then(blob => {
      ...
      document.getElementById("img_1").src = url; // Update image source
    });
  }

  function makeReddish() {
    const image = new ImageJS(document.getElementById("img_2"));
    ...
    document.getElementById("img_2").src = image.toDataURL();
  }
